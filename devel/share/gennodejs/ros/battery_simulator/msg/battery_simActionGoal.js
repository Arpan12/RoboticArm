...
class battery_simActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = battery_simGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new battery_simActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = battery_simGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new battery_simGoal()
    }
...
module.exports = battery_simActionGoal;
