...
class battery_simActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new battery_simFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = battery_simFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new battery_simActionFeedback(null);
    ...
    data.feedback = battery_simFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new battery_simActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = battery_simFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new battery_simFeedback()
    }
...
module.exports = battery_simActionFeedback;
